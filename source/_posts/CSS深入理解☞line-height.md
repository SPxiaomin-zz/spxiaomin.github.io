...
{% codepen SPxiaomin XgXwOZ 0 result 265 %}
...
和上面的大图片不同，这里的图片很小，基本上高度受行高控制。

{% codepen SPxiaomin BZjgYR 0 result 265 %}

## line-height 的应用

line-height 平时用的比较多的话，是用在单行文字的垂直居中上面。但是有一点要注意的是，如下代码中的 `height: 36px` 是不需要的。
...
{% codepen SPxiaomin BZjgEw 0 result 265 %}

### 多行文字垂直居中

{% codepen SPxiaomin GEZBVr 0 result 265 %}
